...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transportgetoptions_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='transport.transportgetoptions')),
                ('grip_mode', models.CharField(choices=[('GripOnShortSide', 'GripOnShortSide'), ('GripOnLongSide', 'GripOnLongSide')], max_length=20)),
                ...
                ('labware_orientation', models.CharField(choices=[('NegativeYAxis', 'Carrier'), ('PositiveXAxis', 'Complex'), ('PositiveYAxis', 'Carrier'), ('NegativeXAxis', 'Complex')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retract_distance', models.FloatField()),
                ('liftup_height', models.FloatField()),
                ('labware_orientation', models.CharField(choices=[('NegativeYAxis', 'NegativeYAxis'), ('PositiveXAxis', 'PositiveXAxis'), ('PositiveYAxis', 'PositiveYAxis'), ('NegativeXAxis', 'NegativeXAxis')], max_length=20)),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
