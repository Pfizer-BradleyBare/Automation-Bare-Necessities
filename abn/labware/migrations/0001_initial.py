# Generated by Django 4.1.6 on 2024-07-12 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calibration_points', models.JSONField(help_text='Should be a list of dictionary values containing \'Volume\' and \'Height\' where \'Volume\' is in uL and \'Height\' is in mm. Ex. [{"Volume":0,"Height":0},{"Volume":100,"Height":10}]')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
