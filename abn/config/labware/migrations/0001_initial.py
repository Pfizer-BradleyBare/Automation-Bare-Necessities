    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calibration_points', models.JSONField(default=config.labware.models.json_default, help_text='Should be a list of dictionary values containing \'Volume\' and \'Height\' where \'Volume\' is in uL and \'Height\' is in mm. Ex. [{"Volume":0,"Height":0},{"Volume":100,"Height":10}]')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
